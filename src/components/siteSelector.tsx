...
const CancerTypeSelector = ({
  ...
  const handleTypeChange = (tcgaCode: string) => {
    // Allow multiple project selections in both modes
  ...
  const handleSelectAllTypes = () => {
    // Allow selecting all projects in both modes
          ...
          {cancerTypes.length > 0 && (
            <>
              <Button
                ...
                className="mt-2 mr-2"
                variant="outline"
                disabled={loadingTypes || selectedCancerTypes.length === 0}
              >
                Clear Projects
              </Button>
              <Button
                ...
                variant="outline"
                className="mt-2"
                disabled={loadingTypes || selectedCancerTypes.length === cancerTypes.length}
              >
                Select All Projects
              </Button>
            </>
      ...
      {(selectedSites.length > 0 || selectedCancerTypes.length > 0) && (
        <div className="p-4 bg-blue-50 border rounded-lg">
          ...
          {Object.keys(groupedBySite).length > 0 && (
            <>
              <h4 className="font-medium text-blue-800 mb-2">Selected Projects by Site:</h4>
