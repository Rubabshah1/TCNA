...
// components/types/genes.ts
export interface GeneStats {
  gene: string;                    // Display: "TP53 (ENSG00000141510)"
  gene_symbol: string;             // "TP53"
  ensembl_id: string;              // "ENSG00000141510"
  
  site: string;
  normalizationMethod: "tpm" | "fpkm" | "fpkm_uq";
  dataFormat: "raw" | "log2";
  ...
  // Optional: keep raw values for plotting
  [key: string]: any;
}
