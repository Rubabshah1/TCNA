...
// //             Select a cancer type to analyse its noise and tumor values across different metrics. 
// //           </p>
// //         </div>
// //         {/* Selection Controls */}
...
// import { Link, useNavigate } from "react-router-dom";
// import CancerTypeSelector from "@/components/siteSelector"; // Your updated selector

// const TumorAnalysis = () => {
//   const [selectedCancerTypes, setSelectedCancerTypes] = useState<string[]>([]);
//   const navigate = useNavigate();

//   // const canShowAnalysis = selectedCancerTypes.length > 0;
//   const canShowAnalysis = true;
...
//           <CardHeader>
//             <CardTitle className="text-xl text-blue-800">Select Cancer Type(s)</CardTitle>
//           </CardHeader>
//           <CardContent>
//             <CancerTypeSelector
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-blue-700 hidden sm:block">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <footer className="bg-gray-100 text-gray-700 text-m mt-10 p-8 text-center border-t border-gray-300">
          <p className="text-blue-700 mt-4">
            © 2025 BIRL — This website is free and open to all users and there is no login requirement.
          </p>
